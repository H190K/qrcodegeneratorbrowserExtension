...
## License:
This project is licensed under the [GNU General Public License (GPL) Version 3](https://www.gnu.org/licenses/gpl-3.0.html).

## Contributing:
Feel free to fork the repository and submit pull requests if you'd like to improve the extension.

## Contact:
If you have any questions or suggestions, feel free to open an issue or reach out to me directly on [X/Twitter](https://x.com/h190k).
